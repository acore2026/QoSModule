...
func main() {
	...
	flag.StringVar(&coreMode, "core-mode", "ran", "core enforcement mode: ran|ran-udp|ngap|auto (ngap/auto 已随方案 A 废弃)")
	flag.StringVar(&smfEndpoint, "smf-endpoint", "", "SMF OAM qos-update URL (for ngap/auto mode, 方案 A, 已废弃), e.g. http://10.100.200.8:8000/nsmf-oam/v1/qos-update")
	...
	flag.StringVar(&ranUDPEndpoint, "ran-udp-endpoint", "", "gNB UDP QoS endpoint (for ran-udp mode), e.g. 10.88.120.212:9999")
